...
import com.chaodroid.flyrecyclerview.base.RcvBaseAdapter;
...
public class FlyRcvAdapterNew<T> extends RcvBaseAdapter implements RcvViewType {
...
//    }
    ...
    public FlyRcvAdapterNew(FlyRcvAdapterBuilder<T> builder) {
        this.mContext = builder.getContext();
        this.mInflater = builder.getInflater();
        this.mRecyclerView = builder.getRecyclerView();
        this.mDatas = builder.getDatas();
        this.mItems = builder.getItems();
        this.mHeads = builder.getHeads();
        this.mFoots = builder.getFoots();
        this.mViewTypeHandler = builder.getViewTypeHandler();
        this.mItemClickListener = builder.getItemClickListener();
        this.mLongClickListener = builder.getLongClickListener();
        this.mBottomListener = builder.getBottomListener();

        init();
    }

//    public FlyRcvAdapter(Builder builder) {
...
//        }
//
//        public Builder addItem(@NonNull RcvItemView itemView) {
//            if (mItems == null) {
...
//        }
//
//        public Builder addItem(@IntRange(from = TYPE_ITEM_START, to = TYPE_ITEM_END) int viewType,
...
//        }
//
//        public Builder itemType(RcvViewTypeHandler viewTypeHandler) {
//            mViewTypeHandler = viewTypeHandler;
//            return this;
//        }
//
//        public Builder addHead(@NonNull RcvCreateHandler createHandler,
//                               @NonNull RcvBindHandler bindHandler) {
//            if (mHeads == null) {
...
//        }
//
//        public Builder addFoot(@NonNull RcvCreateHandler createHandler,
//                               @NonNull RcvBindHandler bindHandler) {
//            if (mFoots == null) {
...
//        }
//
//        public Builder setRcvItemClickListener(RcvItemClickListener listener) {
//            mItemClickListener = listener;
//            return this;
//        }
//
//        public Builder setRcvLongClickListener(RcvItemLongClickListener listener) {
//            mLongClickListener = listener;
//            return this;
//        }
//
//        public Builder addScrollBottomListener(RcvScrollBottomListener listener) {
//            mBottomListener = listener;
//            return this;
//        }
//
//        public FlyRcvAdapter create() {
//
